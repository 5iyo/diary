...
public class DiaryRepositoryTest {
    ...
    public void 여행별_일기조회_테스트() {
        ...
        // Then
        assertThat(diaries.get(0).getTitle()).isEqualTo("diary1");
        assertThat(diaries.get(0).getTravelDate()).isEqualTo(diaryDate1);
        assertThat(diaries.get(0).getWeather()).isEqualTo("맑음");
        assertThat(diaries.get(0).getMainText()).isEqualTo("주절주절");
        ...
        assertThat(diaries.get(2).getTitle()).isEqualTo("diary3");
        assertThat(diaries.get(2).getTravelDate()).isEqualTo(diaryDate3);
        assertThat(diaries.get(2).getWeather()).isEqualTo("비");
        assertThat(diaries.get(2).getMainText()).isEqualTo("쥬절쥬절");
    }
