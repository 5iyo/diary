                  ...
                  child: ListView(
                    children: [
                      Row(
                        children: <Widget>[
                          Expanded(
                              child: CustomDatePicker(controller: _date,
                                  init: "여행 날짜 선택",
                                                ...
                                                Stack(
                                                  children: <Widget>[
                                                    Container(
                                                      ...
                                                      height: 200.0,
                                                      child: diaryImage[0] == " " && diaryImage.length == 1 ?
                                                      Center(child: Text("이미지를 등록해주세요"))
                                                          ...
                                                          itemBuilder: (BuildContext context, int index) {
                                                            diaryImage[index] == " " || diaryImage[index] == null ? data = null
                                                                : data = Uri.parse(diaryImage[index]).data;
                                                                  ...
                                                                  Positioned(
                                                                    ...
                                                                    child: GestureDetector(
                                                                      onTap: () async{
                                                                        ...
                                                                        if(!(bytes == null)) {
                                                                          if(value.diaryImage.images!.length == 1) {
                                                                            diaryImage.add(" ");
                                                                            await diaryImageInputProvider.imageInput(id, " ");
                        ...
                        funPageRoute: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            await diaryUpdateProvider.update(
                                id, _selectedTitle, _selectedDate,
                                _selectedContent, _selectedWeather,
                                _selectedTravel);
