        ...
        child: ListView(
          children: [
            Row(
              children: <Widget>[
                Expanded(
                    child: CustomDatePicker(controller: _date, init: "여행 날짜 선택", funValidator: validateDate())),
              ...
              children: [
                  ...
                  child: IconButton(
                    ...
                    onPressed: diaryImage.length >= 3
                      ...
                      if(check){
                        ...
                        final stringgfile = base64Encode(gfile.readAsBytesSync());
                ...
                Expanded(
                  ...
                  child: CustomElavatedButton(
                    text: "수정하기",
                    funPageRoute: () async {
                      _title.text == null ? _selectedTitle = snapshot.data.title : _selectedTitle = _title.text;
                      _selectedWeather == null ? _selectedWeather = snapshot.data.weather : _selectedWeather;
                      _content.text == null ? _selectedContent = snapshot.data.content : _selectedContent = _content.text;
